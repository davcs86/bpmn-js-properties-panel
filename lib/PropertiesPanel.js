...
PropertiesPanel.prototype._bindListeners = function(container) {
  ...
  domDelegate.bind(container, 'input:not([data-no-trigger-input]), textarea:not([data-no-trigger-input])',
                                  'input:not([data-no-trigger-input])', debounce(handleChange, DEBOUNCE_DELAY));
  // domDelegate.bind(container, 'input, textarea, select', 'change', handleChange);
  domDelegate.bind(container, 'input:not([data-no-trigger-change]), textarea:not([data-no-trigger-change]),' +
                                ' select:not([data-no-trigger-change])', 'change', handleChange);
